...
if($_SESSION['level'] == "petugas"){
    echo '<script>alert("Maaf Pengguna Yang Terhormat \nRequest yang kamu inginkan tidak dapat kami kabulkan");window.location="index.php"</script>';
} elseif($_SESSION['level'] == "pemilik"){
    echo '<script>alert("Maaf Pengguna Yang Terhormat \nRequest yang kamu inginkan tidak dapat kami kabulkan");window.location="laporan.php"</script>';
}
?>
<?php
